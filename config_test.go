...
func TestMain(m *testing.M) {
	...
	retCode := m.Run()
	os.Unsetenv("ECRDATA_CONFIG_FILE")

	os.Exit(retCode)
}

// disableConfigFileEnv checks if the ECRDATA_CONFIG_FILE environment variable
// is set, unsets it, and returns a function that will return
// ECRDATA_CONFIG_FILE to its state before calling disableConfigFileEnv.
func disableConfigFileEnv() func() {
	loc, wasSet := os.LookupEnv("ECRDATA_CONFIG_FILE")
	if wasSet {
		os.Unsetenv("ECRDATA_CONFIG_FILE")
		return func() { os.Setenv("ECRDATA_CONFIG_FILE", loc) }
	}
	return func() {}
}
...
func TestLoadDefaultConfigMissing(t *testing.T) {
	...
	os.Setenv("ECRDATA_APPDATA_DIR", tempAppDataDir)
	defer os.Unsetenv("ECRDATA_APPDATA_DIR")
...
func TestLoadCustomConfigMissing(t *testing.T) {
	...
	os.Setenv("ECRDATA_CONFIG_FILE", goneFile.Name())
...
func TestDefaultConfigAPIListenWithEnv(t *testing.T) {
	...
	os.Setenv("ECRDATA_LISTEN_URL", customListenPath)
...
func TestDefaultConfigHomeDirWithEnvAndFlag(t *testing.T) {
	...
	os.Setenv("ECRDATA_APPDATA_DIR", cliOverride)
	defer os.Unsetenv("ECRDATA_APPDATA_DIR")
...
func TestDefaultConfigTestNetWithEnv(t *testing.T) {
	os.Setenv("ECRDATA_USE_TESTNET", "true")
	defer os.Unsetenv("ECRDATA_USE_TESTNET")
...
func TestDefaultConfigTestNetWithEnvAndBadValue(t *testing.T) {
	os.Setenv("ECRDATA_USE_TESTNET", "no")
	defer os.Unsetenv("ECRDATA_USE_TESTNET")

	_, err := loadConfig()
	if err == nil {
		t.Errorf("Invalid boolean value for ECRDATA_USE_TESTNET did not cause an error.")
	}
}
