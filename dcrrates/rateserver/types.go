...
// satisfies the ECRRatesServer interface. The gRPC server will call this method
// when a client subscription is received.
func (server *RateServer) SubscribeExchanges(hello *dcrrates.ExchangeSubscription, stream dcrrates.ECRRates_SubscribeExchangesServer) (err error) {
