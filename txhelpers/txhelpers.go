...
// MedianCoin gets the median ECR from a slice of float64s
...
// hash) address. See https://github.com/Eacred/eacrdata/issues/358 for details.
...
// string. Initially, decoding as a Eacred address is attempted. If it fails to
// decode, AddressErrorDecodeFailed is returned with AddressTypeUnknown.
// If the address decoded successfully as a Eacred address, it is checked
...
func AddressValidation(address string, params *chaincfg.Params) (dcrutil.Address, AddressType, AddressError) {
	...
	// Determine address type for this valid Eacred address. Ignore the error
