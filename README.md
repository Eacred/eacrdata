...
- Compared to a well-configure PostgreSQL backend, CoackroachDB performance is
  suboptimal. See the [CockroachDB issue](https://github.com/Eacred/eacrdata/issues/1291)
...
converting from standard Eacred data types (e.g. `wire.MsgBlock`) are also
provided.
...
`github.com/Eacred/eacrd/database` with an ffldb storage backend from
...
See the GitHub [issue trackers](https://github.com/Eacred/eacrdata/issues) and
the [project milestones](https://github.com/Eacred/eacrdata/milestones).
...
5. Create a [pull request](https://github.com/Eacred/eacrdata/compare).
