...
Since the Eacred repo may have changes that you do not have locally, you'll want to pull in any changes and rebase.
...
[Code of Conduct](https://github.com/Eacred/eacrdata/blob/master/CODE_OF_CONDUCT.md).
