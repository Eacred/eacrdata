...
const (
	AppName  string = "eacrdata"
	AppMajor uint   = 5
	AppMinor uint   = 2
	AppPatch uint   = 0
)

// go build -v -ldflags "-X github.com/Eacred/eacrdata/version.appPreRelease= -X github.com/Eacred/eacrdata/version.appBuild=`git rev-parse --short HEAD`"
var (
