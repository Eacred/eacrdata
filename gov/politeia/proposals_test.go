...
import (
	...
	"github.com/Eacred/eacrdata/gov/politeia/types"
	pitypes "github.com/Eacred/eacrdata/gov/politeia/types"
	piapi "github.com/eacred/politeia/politeiawww/api/www/v1"
)
...
func TestNewProposalsDB(t *testing.T) {
	var count int
	inputURLPath := "https://proposals.eacred.org"
	expectedPath := "https://proposals.eacred.org/api/v1"
...
func TestGenerateCustomID(t *testing.T) {
	...
	td := []testData{
		...
		{
			title:    "Eacred Bug Bounty Proposal",
			customID: "eacred-bug-bounty-proposal",
		},
		{
		...
		{
			title:    "Proposed Statement Of Work (SOW) For Eacred Blockchain Wallet Tutorial Campaign",
			customID: "proposed-statement-of-work-sow-for-eacred-blockchain-wallet-tutorial-campaign",
		},
	}
...
func TestSaveProposals(t *testing.T) {
	...
	t.Run("Test_update_proposal_if_same_tokenID_and_new_RefID_found", func(t *testing.T) {
		...
		copy2FirstProposal.Name = "Integrate eacred with Trezor hardware wallet."
	...
	t.Run("Test_create_new_proposal_if_new_tokenID_and_duplicate_RefID_found", func(t *testing.T) {
		...
		copy2MockProposal.Name = "Integrate eacred with Trezor hardware wallet."
